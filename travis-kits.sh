...
curl -k https://s3.amazonaws.com/Minecraft.Download/versions/1.8.5/minecraft_server.1.8.5.exe -o ./SupportDownloads/minecraft_server.1.8.5.exe 2>&1 | tee -a ./BSKlog.log
cp -pv ./SupportDownloads/minecraft_server.*.exe ./bin 2>&1 | tee -a ./BSKlog.log
cp -v ./bin/minecraft_server.*.exe ./minecraft_server.1.8.5.exe 2>&1 | tee -a ./BSKlog.log
echo 2>&1 | tee -a ./BSKlog.log
...
cp -pv ./Bukkit_and_Spigot_Getter/craftbukkit-1.8.*.jar ./bin/*
cp -pv ./minecraft_server.1.8.*.exe ./Executable_Basic_Server/*
echo 2>&1 | tee -a ./BSlog.log
cp -pv ./bin/spigot-1.8.*.jar ./* 2>&1 | tee -a ./BSKlog.log
cp -pv ./bin/craftbukkit-1.8.*.jar ./craftbukkit-1.8.*.jar 2>&1 | tee -a ./BSKlog.log
echo 2>&1 | tee -a ./BSKlog.log
